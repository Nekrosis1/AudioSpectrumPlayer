namespace AudioSpectrumPlayer.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "com.Nekrosis.AudioSpectrumPlayer";
    public readonly static string AndroidAppName = "com.Nekrosis.AudioSpectrumPlayer";
